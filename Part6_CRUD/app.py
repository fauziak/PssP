...
mysql_username = os.getenv("MYSQL2_USER")
mysql_password = os.getenv("MYSQL2_PASSWORD")
mysql_host = os.getenv("MYSQL2_HOSTNAME")

db = SQLAlchemy()
app = Flask(__name__)

app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://' + mysql_username + ':' + mysql_password + '@' + mysql_host + ':3306/patientportal'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.secret_key = "xb4\\xa1\\xd6j\\x95A\\x9f_a\\x1c\\x9co"
...
def insert(): # note this function needs to match name in html form action 
    if request.method == 'POST':
        ...
        new_patient = Patients(mrn, first_name, last_name, gender, zip_code, dob, contact_home, contact_mobile)
